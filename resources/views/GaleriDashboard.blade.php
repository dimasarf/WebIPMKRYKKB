    ...
    <div class="container mt-4 mb-4">
      <div class="row">
        <div class="col-lg-6">
          <div class="card card-block-2">
            <div class="card-block ml-5 mt-4 mb-4">
              <h2><span><img src="seluruh.png" alt="" class="img-rounded center-block" width="50px"></span> {{$totalAlbum}}</h2>
        ...
        <div class="col-lg-6">
          <div class="card card-block-2">
            <div class="card-block ml-5 mt-4 mb-4">
              <h2><span><img src="seluruh.png" alt="" class="img-rounded center-block" width="50px"></span> {{$totalFoto}}</h2>
...
<tbody>
  ...
  <tr>
      ...
      <td><a href="/Detail-Foto/{{$album->id}}" class="btn btn-primary">View</a></td>
  </tr>
  @endforeach
              ...
              <div class="form-group">
                ...
                <div class="dropdown">
                  ...
                  <select class="dropdown-menu" name="album" id="album">
                    @foreach ($albumMenus as $albumMenu )
                      <option selected="album" value="{{$albumMenu->id}}">{{$albumMenu->nama}}</option>
                    @endforeach
                  </select>
                </div>
              </div>
