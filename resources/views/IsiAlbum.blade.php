  ...
  <div class="w3-row w3-padding w3-border">
    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        <div class="w3-center">
          <h1 align="center">{{$album->nama}}</h1>
        </div>
        <div class="w3-row-padding w3-padding-32" style="margin:0 -16px">
          @foreach ($fotos as $foto)
            <div class="w3-third w3-margin-bottom">
              <img src="{{ URL::asset('uploads/'.$foto->foto) }}" alt="Norway" style="width:100%" class="zoom">
              <div class="w3-container w3-white">
                <p><b></b></p>
                <p class="w3-opacity">{{$foto->created_at}}</p>
                <a href="/img-download/{{$foto->id}}" class="w3-button w3-black w3-margin-bottom" onclick="document.getElementById('ticketModal').style.display='block'">Download</a>
              </div>
            </div>
          @endforeach
        </div>
        ...
        <ul class="w3-ul w3-hoverable w3-white">
          @foreach ($latestAlbums as $latestAlbum)
            <li class="w3-padding-16">
              ...
              <a href="/galleries/{{$latestAlbum->id}}"class="w3-large">{{$latestAlbum->nama}}</a>
              <br>
              <span>{{$latestAlbum->created_at}}</span>
            </li>
          @endforeach
