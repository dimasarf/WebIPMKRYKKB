  ...
  <div class="w3-row w3-padding w3-border">
    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        <div class="w3-center">
          <h1 align="center">{{$konten->judul}}</h1>
        </div>
        ...
        <div class="w3-justify">
          ...
          <p class="w3-right"><button class="w3-button w3-black" onclick="myFunction('demo1')" id="myBtn"><b>Replies  </b> <span class="w3-tag w3-white">{{$bnykReply}}</span></button></p>
          <p class="w3-clear"></p>
          <div class="w3-row w3-margin-bottom" id="demo1" style="display:none">
            <hr>
              ...
              <div class="w3-col l10 m9">
                  ...
                  <h4>{{$reply->nama}} <span class="w3-opacity w3-medium">{{$reply->created_at}}</span></h4>
                  <p>{{$reply->reply}}</p>
              ...
              @endforeach
              <div class="w3-col l10 m9">
                <form method="post" action="/reply/{{$konten->id}}">
                  {{ csrf_field() }}
    ...
    <div class="w3-col l4">
      ...
      <div class="w3-white w3-margin">
        ...
        <ul class="w3-ul w3-hoverable w3-white">
          @foreach ($latestKontens as $latestKonten)
            <li class="w3-padding-16">
              <img src="/Logo2.png" alt="Image" class="w3-left w3-margin-right" style="width:50px">
              <a href="/post/{{$latestKonten->id}}"class="w3-large">{{$latestKonten->judul}}</a>
              <br>
              <span>{{$latestKonten->created_at}}</span>
            </li>
          @endforeach
      ...
      <div class="w3-white w3-margin">
        ...
        <div class="w3-container w3-white">
          <p>
          <span><a href="/news/{{$katEvent->id}}" class="w3-tag w3-light-grey w3-small w3-margin-bottom">{{$katEvent->kategori}}</a></span> <span><a href="/news/{{$katBerita->id}}" class="w3-tag w3-light-grey w3-small w3-margin-bottom">{{$katBerita->kategori}}</a></span>
          </p>
        </div>
      </div>
      <hr>
