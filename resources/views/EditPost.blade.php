...
@section('content')
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/css/bootstrap.min.css">
    ...
    <div class="card-block mb-4" >
      <form action="{{action('TesKontenController@update', $konten->id)}}" method="POST" class=" mx-auto">
          {{ csrf_field() }}
          <div class="col-lg-12">
            <fieldset class="form-group mt-1">
              <label for="exampleInputEmail1">Judul</label>
              <input type="text" class="form-control" name="judul" placeholder="Masukkan Judul" value="{{$konten->judul}}">
            </fieldset>
            <textarea name="summernoteInput" class="summernote" id="summernote">{{$konten->konten}}</textarea>
            <fieldset class="form-group mt-1">
  ...
  <script>
      /*$(document).ready(function() {
          ...
          var content = {!! json_encode($konten->konten)!!};
